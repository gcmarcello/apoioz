    ...
    <div className="hidden space-y-3 border-t py-4 lg:flex lg:flex-col lg:items-start lg:justify-start ">
      <div className="flex">
        ...
        <div className="flex items-center text-sm text-gray-900">
          {addresses?.filter((data) => data.supportersCount).length || 0} Colégios com
          apoio
        </div>
      </div>
      <div className="flex">
        ...
        <div className="flex items-center text-sm text-gray-900">
          {addresses?.filter((data) => !data.supportersCount).length || 0} Colégios sem
          apoio
        </div>
      </div>
      <div className="flex">
        ...
        <div className="flex items-center text-sm text-gray-900">Apoiadores na área</div>
      </div>
    </div>
  );
}
